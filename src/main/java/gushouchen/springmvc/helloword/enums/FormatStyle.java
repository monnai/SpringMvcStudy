package gushouchen.springmvc.helloword.enums;

public enum FormatStyle {
  // ordered from large to small

  /**
   * Full text style, with the most detail. For example, the format might be 'Tuesday, April 12, 1952 AD' or '3:30:42pm
   * PST'.
   */
  FULL,
  /**
